...
const nextConfig: NextConfig = {
    env: {
        JWT_SECRET: process.env.JWT_SECRET, // untuk client
    },
    ...
    async headers() {
        return [{
            source: "/api/:path*", headers: [{
                ...
                key: "Access-Control-Allow-Origin", value: "*", // Atau ganti dengan domain frontend jika production
            }, {
    ...
    }, trailingSlash: false, basePath: "", reactStrictMode: true, // Enforce React best practices
    images: {
        loader: "default", minimumCacheTTL: 60, localPatterns: [{
