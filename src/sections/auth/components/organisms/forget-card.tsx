...
import ForgetForm from "@/sections/auth/components/organisms/forget-form";

/**
 * LoginCard component that contains the logo and forget form
 */
const ForgetCard: React.FC = () => {
